...
-include_lib(\"action_msgs/src/_rosie/"
    ++ "cancel_goal_srv.hrl\").
-include_lib(\"action_msgs/src/_rosie/"
    ++ "goal_status_array_msg.hrl\").
...
gen_action_erl(PkgName, InterfaceName) ->
    ...
    ++ "goal() -> #"
    ++ InterfaceName
    ++ "_send_goal_rq{goal_id = #u_u_i_d{uuid = binary:bin_to_list(<<(crypto:strong_rand_bytes(16))/binary>>) } }.\n"
    ++ "get_goal_id(#"
    ++ InterfaceName
    ...
    ++ "identify_msg(#"
    ++ InterfaceName
    ++ "_send_goal_rq{}) -> send_goal_rq;\n"
    ++ "identify_msg(#"
    ++ InterfaceName
    ++ "_send_goal_rp{}) -> send_goal_rp;\n"
    ++ "identify_msg(#"
    ++ InterfaceName
